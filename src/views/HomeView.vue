...
<template>
  <div class="landing-page" :class="{ 'dark': isDarkMode, 'light': !isDarkMode }">
    <div class="theme-toggle">
      <Button 
        @click="toggleTheme" 
        :icon="isDarkMode ? 'pi pi-sun' : 'pi pi-moon'"
        class="p-button-text p-button-rounded theme-btn"
      />
    </div>
    ...
    <main class="main-content">
      ...
      <div class="links">
        ...
        >
          <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            <path d="M7 7h10v10H7V7zm3.5 3c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5S12 12.33 12 11.5 11.33 10 10.5 10zm3 0c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5S15 12.33 15 11.5 14.33 10 13.5 10zM9 14h6v2H9v-2z"/>
            <path d="M5 3h14c1.1 0 2 .9 2 2v14c0 1.1-.9 2-2 2H5c-1.1 0-2-.9-2-2V5c0-1.1.9-2 2-2z" fill="none" stroke="currentColor" stroke-width="2"/>
          </svg>
          Apple Music
        </a>
        <a 
...
/* Medium screens and smaller: vertical layout */
